      ...
      {settingName="PluginShadow",settingTable=
        {
          ...
          {name="Low",DirectionalLightShadowResolution=8192,SpotLightLightShadowResolution=4096,PointLightLightShadowResolution=8192,CascadeShadowRangeScale=2,EnableCascadeShadowBlend=1},
          {name="High",DirectionalLightShadowResolution=8192,SpotLightLightShadowResolution=4096,PointLightLightShadowResolution=8192,CascadeShadowRangeScale=3,EnableCascadeShadowBlend=1},
          {name="ExtraHigh",DirectionalLightShadowResolution=10240,SpotLightLightShadowResolution=8192,PointLightLightShadowResolution=10240,CascadeShadowRangeScale=4,EnableCascadeShadowBlend=1}}},
      {settingName="PluginSphericalHarmonics",settingTable=
        {
          ...
          {name="Low",DrawSphericalHarmonicsMaxCount=255,RejectionLengthBias=80},
          {name="High",DrawSphericalHarmonicsMaxCount=512,RejectionLengthBias=100},
          {name="ExtraHigh",DrawSphericalHarmonicsMaxCount=1024,RejectionLengthBias=400}}},
      ...
      {settingName="PluginLocalLight",settingTable=
        {
          ...
          {name="Low",ShadowCastingStaticLocalLightMaxCount=12,ShadowCastingDynamicLocalLightMaxCount=4,DrawLocalLightMaxCount=512,LocalLightLodLevelBias=-.5,LocalLightLodMinLevel=0,RejectionLengthBias=200},
          {name="High",ShadowCastingStaticLocalLightMaxCount=16,ShadowCastingDynamicLocalLightMaxCount=6,DrawLocalLightMaxCount=768,LocalLightLodLevelBias=-1,LocalLightLodMinLevel=0,RejectionLengthBias=400},
          {name="ExtraHigh",ShadowCastingStaticLocalLightMaxCount=36,ShadowCastingDynamicLocalLightMaxCount=8,DrawLocalLightMaxCount=1024,LocalLightLodLevelBias=-1,LocalLightLodMinLevel=0,RejectionLengthBias=800}}},
      ...
      {settingName="PluginModel",settingTable=
        {
          ...
          {name="Low",RejectionLengthBias=128},
          {name="Medium",RejectionLengthBias=16},
          {name="High",RejectionLengthBias=512},
          {name="ExtraHigh",RejectionLengthBias=1024}}},
      ...
      {settingName="PluginDof",settingTable=
        {
          ...
          {name="Low",EnableFilter=1,QualityType=1},
          {name="High",EnableFilter=1,QualityType=1},
      ...
      {settingName="PluginMotionBlur",settingTable=
        {
          ...
          {name="Low",EnableFilter=1,BaseAmount=.01},
      ...
      {settingName="PluginLocalReflection",settingTable=
        {
          ...
          {name="Low",EnableFilter=1,FadeOffset=.9},
          {name="High",EnableFilter=1,FadeOffset=.9},
      ...
      {settingName="PluginSubsurfaceScatter",settingTable=
        {
          ...
          {name="Off",EnableFilter=0,FadeOffset=0},
          {name="Low",EnableFilter=1,FadeOffset=1},
